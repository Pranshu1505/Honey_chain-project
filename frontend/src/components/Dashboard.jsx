    ...
    const fetchDashboardStats = async () => {
        try {
            ...
            const [beekeepersRes, hivesRes, sensorsRes, batchesRes] = await Promise.all([
                fetch('http://192.168.1.11:8000/api/beekeeper/apiaries/', { headers }),
                fetch('http://192.168.1.11:8000/api/hive/', { headers }),
                fetch('http://192.168.1.11:8000/api/sensor/', { headers }),
                fetch('http://192.168.1.11:8000/api/batch/', { headers })
            ]);
